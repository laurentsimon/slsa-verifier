...
var (
	...
	ErrorMismatchVerifierID          = errors.New("verifierID does not match VSA")
	...
	ErrorVsaVerifierNotSupported     = errors.New("no verifier supports the VSA builder")
	ErrorBuilderVerifierNotSupported = errors.New("no verifier supports the SLSA builder")
	ErrorInvalidPredicate            = errors.New("invalid predicate")
	ErrorInvalidVsaLevel             = errors.New("invalid VSA level")
	ErrorMismatchVsaLevel            = errors.New("mismatch VSA level")
	ErrorMismatchVsaResourceURI      = errors.New("mismatch VSA resource URI")
	ErrorVsaResultFailure            = errors.New("verification result failed")
)
